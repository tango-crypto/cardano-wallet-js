...
if (os.platform() !== 'win32') {
	...
	execSync('echo @ECHO off> node_modules\\.bin\\cardano-address.exe.cmd');
	execSync('echo SETLOCAL>> node_modules\\.bin\\cardano-address.exe.cmd');
	execSync('echo CALL :find_dp0>> node_modules\\.bin\\cardano-address.exe.cmd');
	execSync('echo ^"%dp0%\\node_modules\\cardano-wallet-js\\cli\\cardano-address.exe^"   %*>> node_modules\\.bin\\cardano-address.exe.cmd');
	execSync('echo ENDLOCAL>> node_modules\\.bin\\cardano-address.exe.cmd');
	execSync(`echo EXIT /b ^%errorlevel^%>> node_modules\\.bin\\cardano-address.exe.cmd`);
	execSync('echo :find_dp0>> node_modules\\.bin\\cardano-address.exe.cmd');
	execSync('echo SET dp0=%~dp0>> node_modules\\.bin\\cardano-address.exe.cmd');
	execSync('echo EXIT /b>> node_modules\\.bin\\cardano-address.exe.cmd');
